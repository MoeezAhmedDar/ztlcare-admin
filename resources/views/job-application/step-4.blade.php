...
<div class="form-container">
    ...
    <div class="form-body">
        ...
        <form action="{{ route('job-application.store-step', 4) }}" method="POST">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="professional_body" id="professional_body" class="form-control" value="{{ old('professional_body', $formData['step_4']['professional_body'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="pin">PIN (if applicable)</label>
                            <input type="text" name="pin" id="pin" class="form-control" value="{{ old('pin', $formData['step_4']['pin'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="renewal_date">Renewal Date</label>
                            <input type="date" name="renewal_date" id="renewal_date" class="form-control" value="{{ old('renewal_date', $formData['step_4']['renewal_date'] ?? '') }}">
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="pvg_number">Current PVG/DBS Number</label>
                            <input type="text" name="pvg_number" id="pvg_number" class="form-control" value="{{ old('pvg_number', $formData['step_4']['pvg_number'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label>Clear?</label>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="pvg_clear_yes" name="pvg_clear" class="custom-control-input" value="1" {{ old('pvg_clear', $formData['step_4']['pvg_clear'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="pvg_clear_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="pvg_clear_no" name="pvg_clear" class="custom-control-input" value="0" {{ old('pvg_clear', $formData['step_4']['pvg_clear'] ?? '') == '0' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="pvg_clear_no">No</label>
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="pvg_issue_date">Issue Date</label>
                            <input type="date" name="pvg_issue_date" id="pvg_issue_date" class="form-control" value="{{ old('pvg_issue_date', $formData['step_4']['pvg_issue_date'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="pvg_updated_yes" name="pvg_updated_service" class="custom-control-input" value="1" {{ old('pvg_updated_service', $formData['step_4']['pvg_updated_service'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="pvg_updated_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="pvg_updated_no" name="pvg_updated_service" class="custom-control-input" value="0" {{ old('pvg_updated_service', $formData['step_4']['pvg_updated_service'] ?? '') == '0' ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="bank_name" id="bank_name" class="form-control" value="{{ old('bank_name', $formData['step_4']['bank_name'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="account_name">Account Name</label>
                            <input type="text" name="account_name" id="account_name" class="form-control" value="{{ old('account_name', $formData['step_4']['account_name'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="account_personal" name="account_type" class="custom-control-input" value="Personal" {{ old('account_type', $formData['step_4']['account_type'] ?? '') === 'Personal' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="account_personal">Personal</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="account_ltd" name="account_type" class="custom-control-input" value="LTD" {{ old('account_type', $formData['step_4']['account_type'] ?? '') === 'LTD' ? 'checked' : '' }}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="bank_postcode" id="bank_postcode" class="form-control" value="{{ old('bank_postcode', $formData['step_4']['bank_postcode'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="account_number">Account No.</label>
                            <input type="text" name="account_number" id="account_number" class="form-control" value="{{ old('account_number', $formData['step_4']['account_number'] ?? '') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="sort_code">Sort Code</label>
                            <input type="text" name="sort_code" id="sort_code" class="form-control" placeholder="00-00-00" value="{{ old('sort_code', $formData['step_4']['sort_code'] ?? '') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="license_yes" name="has_uk_license" class="custom-control-input" value="1" {{ old('has_uk_license', $formData['step_4']['has_uk_license'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="license_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="license_no" name="has_uk_license" class="custom-control-input" value="0" {{ old('has_uk_license', $formData['step_4']['has_uk_license'] ?? '') == '0' ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="car_yes" name="has_car" class="custom-control-input" value="1" {{ old('has_car', $formData['step_4']['has_car'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="car_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="car_no" name="has_car" class="custom-control-input" value="0" {{ old('has_car', $formData['step_4']['has_car'] ?? '') == '0' ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="hep_b_yes" name="immunisations[hep_b]" value="1" {{ ($savedImm['hep_b'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="hep_b_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="hep_b_no" name="immunisations[hep_b]" value="0" {{ ($savedImm['hep_b'] ?? '') == '0' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="tb_yes" name="immunisations[tb]" value="1" {{ ($savedImm['tb'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="tb_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="tb_no" name="immunisations[tb]" value="0" {{ ($savedImm['tb'] ?? '') == '0' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="varicella_yes" name="immunisations[varicella]" value="1" {{ ($savedImm['varicella'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="varicella_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="varicella_no" name="immunisations[varicella]" value="0" {{ ($savedImm['varicella'] ?? '') == '0' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="measles_yes" name="immunisations[measles]" value="1" {{ ($savedImm['measles'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="measles_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="measles_no" name="immunisations[measles]" value="0" {{ ($savedImm['measles'] ?? '') == '0' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="rubella_yes" name="immunisations[rubella]" value="1" {{ ($savedImm['rubella'] ?? '') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="rubella_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="rubella_no" name="immunisations[rubella]" value="0" {{ ($savedImm['rubella'] ?? '') == '0' ? 'checked' : '' }}>
